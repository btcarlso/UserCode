...
# with command line options: Configuration/Generator/python/SingleTaupt_50_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco,RECO --mc --no_exec --conditions auto:mc -n 10
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/SingleTaupt_50_cfi.py nevts:10'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('JpsiGun.root'),
...
process.generator = cms.EDProducer("Pythia6PtGun",
    ...
    PythiaParameters = cms.PSet(
        ...
        parameterSets = cms.vstring('pythiaUESettings', 
            'pythiaTauJets'),
        pythiaTauJets = cms.vstring('MDME(858,1)=0                 ! J/psi -> ee turned ON',
