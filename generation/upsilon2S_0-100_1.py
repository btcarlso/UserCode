...
process.load('IOMC.EventVertexGenerators.VtxSmearedEarly7TeVCollision_cfi')
...
process.RandomNumberGeneratorService.pregenerator = cms.PSet(
        initialSeed = cms.untracked.uint32(932781),
...
process.pregenerator = cms.EDProducer("FlatRapidFlatPtGunProducer",
        ...
        PartID = cms.vint32(100553),
            MinRapidity = cms.untracked.double(-0.5),
            MaxRapidity = cms.untracked.double(0.5),
            #
...
process.generator = cms.EDProducer("EvtGenProducer",
                                       ...
                                       list_forced_decays = cms.vstring('MyUpsilon2'),
                                       processParameters = cms.vstring(
                    'MDME(858,1)=0                 ! Upsilon -> ee turned OFF',
                    'MDME(859,1)=1                 ! Upsilon -> mumu turned OFF',
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/afs/cern.ch/work/b/bcarlson/public/UpsData/upsilon_2S_RECO_1.root'),
