...
bool W_enriched=false; 
bool W_enriched_bveto=false; 

bool dimuon_enriched=false;
bool dimuon_enriched_ss=false;

bool Z_enriched=false;
bool Z_enriched_ss=false;
bool Z_enriched_loose=false;
bool Z_enriched_bveto=false;
bool tt_enriched=false;
bool tt_enriched_ss=false;

bool tt_enriched_btag=false;
